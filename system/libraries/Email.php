...
class CI_Email {
	...
	var	$smtp_host		= "mail.boginsky.naddaka.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "webmaster@boginsky.naddaka.com";		// SMTP Username
	var	$smtp_pass		= "lLkAWtcD";		// SMTP Password
